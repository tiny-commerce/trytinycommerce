...
This Privacy Policy describes how {{ $doc.companyName }} (the "**Site**", "**we**", "**us**", or "**our**") collects, uses, and discloses your personal information when you visit {{ $
doc.website }} (the "**Site**") or otherwise communicate with us (collectively, the "**Services**"). For purposes of this Privacy Policy, "**you**" and "**your**" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
...
- **Providing Products and Services**. We use your personal information to provide you with the Services in order to perform our contract with you, including to process your payments, to send notifications to you related to you account, to create, maintain and otherwise manage your account.
