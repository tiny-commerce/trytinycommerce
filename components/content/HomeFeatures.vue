      ...
      <div class="grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
        <div class="relative lg:col-span-3">
          ...
          >
            ...
            />
            <div class="p-10 pt-4">
              <h3 class="text-sm/4 font-semibold text-secondary">Performance</h3>
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950">Lightning-fast builds</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        ...
        <div class="relative lg:col-span-3">
          ...
          >
            <img
              alt="" class="h-80 object-cover object-left lg:object-right"
              src="https://tailwindui.com/plus-assets/img/component-images/bento-01-releases.png"
            />
            <div class="p-10 pt-4">
              <h3 class="text-sm/4 font-semibold text-secondary">Releases</h3>
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950">Push to deploy</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600">Curabitur auctor, ex quis auctor venenatis, eros arcu
                rhoncus massa, laoreet dapibus ex elit vitae odio.</p>
            </div>
          </div>
          <div
        ...
        <div class="relative lg:col-span-2">
          ...
          >
            ...
            />
            <div class="p-10 pt-4">
              <h3 class="text-sm/4 font-semibold text-secondary">Speed</h3>
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950">Built for power users</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600">Sed congue eros non finibus molestie. Vestibulum euismod
                augue.</p>
            </div>
          </div>
          <div
        ...
        <div class="relative lg:col-span-2">
          ...
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
            <img
              alt="" class="h-80 object-cover"
              src="https://tailwindui.com/plus-assets/img/component-images/bento-01-integrations.png"
            />
            <div class="p-10 pt-4">
              <h3 class="text-sm/4 font-semibold text-secondary">Integrations</h3>
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950">Connect your favorite tools</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600">Maecenas at augue sed elit dictum vulputate, in nisi
        ...
        <div class="relative lg:col-span-2">
          ...
          >
            ...
            />
            <div class="p-10 pt-4">
              <h3 class="text-sm/4 font-semibold text-secondary">Network</h3>
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950">Globally distributed CDN</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600">Aenean vulputate justo commodo auctor vehicula in
                malesuada semper.</p>
            </div>
          </div>
          <div
